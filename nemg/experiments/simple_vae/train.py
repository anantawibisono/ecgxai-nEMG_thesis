...
def main(cfg: DictConfig) -> None:
    ...
    print("len(val_dataset):", len(val_loader.dataset))
    print("len(train_loader):", len(train_loader))
    print("len(val_loader):", len(val_loader))
    print("max_train_batches:", cfg.trainer.max_train_batches)
    print("max_val_batches:", cfg.trainer.max_val_batches)
    ...
    if run is not None and cfg.logger.watch_model:
    ...
    for epoch in range(1, cfg.trainer.epochs + 1):
        ...
        beta = beta_for_epoch(
            epoch=epoch,
            beta=cfg.model.beta,
            warmup_epochs=cfg.model.beta_warmup_epochs,
        )
        ...
        if (
            ...
            plot_path = recon_dir / f"epoch_{epoch:03d}.png"
    ...
    final_plot_path = recon_dir / "final.png"
    save_reconstruction_plot(
        model=model,
        loader=val_loader,
        device=device,
